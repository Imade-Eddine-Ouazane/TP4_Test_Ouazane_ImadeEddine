...
public class TestRoutage {
    ...
    public static void main(String[] args) throws Exception {
        ...
        EmbeddingStoreWithSegments storeCuisineWithSegments = creerEmbeddingStore("src/main/resources/Mirrlees2020SocialMedia.pdf", embeddingModel, parser);

        EmbeddingStore<TextSegment> storeIA = storeIAWithSegments.store();
        EmbeddingStore<TextSegment> storeCuisine = storeCuisineWithSegments.store();
